...
-   **Several features and behaviors have been removed:**
    ...
    -   Desktop environment specific integrations.
        ...
        **Reason:** Temporal work-arounds and data mappings are needed to support these, due to lack of software vendor adherence to or lack of the definition within the XDG specifications. Are not required for providing the core functionality of this tool.
